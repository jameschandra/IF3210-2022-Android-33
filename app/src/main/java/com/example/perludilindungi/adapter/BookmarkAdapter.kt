...
class BookmarkAdapter : RecyclerView.Adapter<BookmarkAdapter.FaskesListViewHolder>() {
    private var faskesList = emptyList<Faskes>()
    ...
    fun setData(faskesList: List<Faskes>) {
